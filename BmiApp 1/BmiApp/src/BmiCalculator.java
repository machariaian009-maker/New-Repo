public class BmiCalculator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter Height (cm)");
        ...
        jLabel3.setText("Welcome to BMI App");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(112, 112, 112)
                        .addComponent(lblResult, javax.swing.GroupLayout.PREFERRED_SIZE, 343, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(txtHeight, javax.swing.GroupLayout.DEFAULT_SIZE, 114, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String category;
        if (bmi < 18.5) {
            category = "Underweight - Eat more body building food";
        } else if (bmi < 25) {
            category = "Normal weight - Keep the good health practices";
        } else if (bmi < 30) {
            category = "Overweight - You should reduce weight";
        } else {
            category = "Obese - You should reduce weight";
        }
